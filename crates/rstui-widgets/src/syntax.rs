...
const GO_KEYWORDS: &[&str] = &[
    "any", "bool", "break", "byte", "case", "chan", "const", "continue", "default", "defer", "else",
    "error", "fallthrough", "false", "float32", "float64", "for", "func", "go", "goto", "if",
    "import", "int", "int16", "int32", "int64", "int8", "interface", "map", "nil", "package",
    "range", "return", "rune", "select", "string", "struct", "switch", "true", "type", "uint",
...
const JS_KEYWORDS: &[&str] = &[
    ...
    "import", "in", "instanceof", "interface", "let", "namespace", "never", "new", "null",
    "number", "object", "of", "private", "protected", "public", "readonly", "return", "set",
...
const C_KEYWORDS: &[&str] = &[
    ...
    "delete", "do", "double", "else", "enum", "extern", "false", "float", "for", "goto", "if",
    ...
    "template", "this", "throw", "true", "typedef", "typename", "union", "unsigned", "using",
...
mod tests {
    ...
    fn keyword_sets_are_language_specific() {
        ...
        assert_eq!(spans(&ov("func main()", Language::Go), st.keyword), vec![(0, 4)]);
        assert_eq!(
            spans(&ov("func main()", Language::Python), st.keyword),
            Vec::<(usize, usize)>::new()
        );
        // `def` is a Python keyword but not Go's.
        assert_eq!(spans(&ov("def main()", Language::Python), st.keyword), vec![(0, 3)]);
        assert_eq!(
            spans(&ov("def main()", Language::Go), st.keyword),
            Vec::<(usize, usize)>::new()
        );
        // `func`/`def` are both in the Unknown common core.
        assert_eq!(spans(&ov("func x", Language::Unknown), st.keyword), vec![(0, 4)]);
        assert_eq!(spans(&ov("def x", Language::Unknown), st.keyword), vec![(0, 3)]);
    }
    ...
    fn markdown_has_no_code_tokens() {
        let o = ov(r#"# Heading with `code` and 12 and "q""#, Language::Markdown);
    ...
    fn unknown_common_keyword_set_is_the_legacy_diff_set() {
        const LEGACY: &[&str] = &[
            "abstract", "and", "as", "async", "await", "begin", "bool", "break", "byte", "case",
            "catch", "char", "class", "const", "continue", "data", "def", "default", "defer",
            "del", "do", "double", "elif", "else", "end", "enum", "except", "export", "extends",
            "extern", "false", "final", "finally", "float", "fn", "for", "from", "func",
            "function", "go", "goto", "if", "impl", "implements", "import", "in", "instanceof",
            "int", "interface", "is", "lambda", "let", "long", "loop", "match", "mod", "module",
            "move", "mut", "namespace", "new", "nil", "none", "not", "null", "object", "or",
            "package", "pass", "private", "protected", "pub", "public", "raise", "ref", "return",
            "select", "self", "short", "signed", "sizeof", "static", "str", "struct", "super",
            "switch", "template", "then", "this", "throw", "throws", "trait", "true", "try",
            "type", "typedef", "typeof", "union", "unsafe", "unsigned", "use", "using", "var",
