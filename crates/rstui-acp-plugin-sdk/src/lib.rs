...
pub use plugin::{
    Host, Plugin, serve, serve_auto, serve_over, serve_plugin, serve_plugin_shm, serve_plugin_ws,
    serve_shm, serve_stdio_lp, serve_unix, serve_ws,
};
pub use proto::{
...
pub use transport::{IoTransport, LpTransport, ShmTransport};
